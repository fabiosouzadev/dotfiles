...
def extract_company_from_content(content: str, url: str) -> str:
    ...
    if email_match:
        ...
        if domain and len(domain) > 2:
            ...
            # Mas aceitar domínios válidos de empresa (letras, números, hífens)
            if not re.search(r'[\._]', domain) and re.match(r'^[a-zA-Z0-9-]+$', domain):
